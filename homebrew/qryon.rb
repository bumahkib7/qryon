class Qryon < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bumahkib7/qryon/releases/download/v0.14.0/qryon-aarch64-apple-darwin.tar.gz"
      sha256 "8fcfb89d15e5dfc9f23b18be837fa2e00d9b4bd520d404ef810b57ed8645acb2"
    end
    on_intel do
      url "https://github.com/bumahkib7/qryon/releases/download/v0.14.0/qryon-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/bumahkib7/qryon/releases/download/v0.14.0/qryon-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "b9c01b98f968368891bb8cae5bd44a94b6027ef2cc0571dd1dec3295901d13b1"
    end
    on_intel do
      url "https://github.com/bumahkib7/qryon/releases/download/v0.14.0/qryon-x86_64-unknown-linux-gnu.tar.gz"
