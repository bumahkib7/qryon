...
pub const DEFAULT_HTML_FILENAME: &str = "qryon-report.html";
...
<head>
    ...
    <title>Qryon Security Report - {project_name}</title>
    {css}
</head>
<body>
    <div class="container">
        <header class="header">
            <h1>Qryon Security Report</h1>
        ...
        <footer class="footer">
            <p>Generated by Qryon v{version}</p>
        </footer>
    </div>
    {javascript}
</body>
